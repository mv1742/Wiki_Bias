...
sql_query_0 = "SELECT * FROM groupby_article_large_edits ORDER BY reverts DESC LIMIT 50;"
...
sql_query_4 = "SELECT * FROM source_score_reverts ORDER BY avg DESC LIMIT 50;"
